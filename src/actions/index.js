...
export const SET_FILES_LIST_LOADING = 'SET_FILES_LIST_LOADING';
...
export const setFilesListLoading = createAction(SET_FILES_LIST_LOADING, (loading) => loading);
export const setSetSyncStatus = createAction(SET_SYNC_STATUS, (status) => status);
